...
input_path = 'E:/engyne_work/phone/source_video/Abnormal_image/20181213/image_output'
output_path = 'E:/engyne_work/phone/source_video/Abnormal_image/20181213/rotated_image_output'

imgpath = input_path + '/JPEGImages/'          #源图像路径
xmlpath = input_path + '/Annotations/'         #源图像所对应的xml文件路径
rotated_imgpath = output_path + '/rotated_JPEGImages/'
rotated_xmlpath = output_path + '/rotated_Annotations/'
# create new train.txt
outfile = output_path + '/ImageSets/Main/rotated_train.txt'
# 
