...
def get_photos(url,new_fpath):
    result = get_url(url)
    pattern = re.compile(r'src="https://images.pexels.com/photos/(\d+)/(.*?)\?auto=compress&amp;cs=tinysrgb&amp;h=350"',re.S)
    # src="https://images.pexels.com/photos/288530/pexels-photo-288530.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=350
